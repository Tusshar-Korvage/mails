...
<body>
    ...
    <div class="container">
        <p class="mb-0" style="text-align: left;">
            <b>Dear {{ vendor_name }},</b>
        </p>
        <div>
            <p>We hope this email finds you well. We want to inform you that your activity titled
                "<b>{{ activity_title }}</b>" has been marked as unverified by our admin team. This means that the
                activity will not be visible to customers on our platform until it is verified again.</p>
