...
Notification: {Vendor Name} has topped up for "<b><I>Activity</I></b>". Please review and update accordingly. --}}
<body>
    ...
    <div class="container">
        ...
        <div>
            <p>We want to inform you that {{ isset($vendor_name) ? $vendor_name : 'Vendor' }} has successfully topped up their current subscription plan for the "Activity".</p>
        </div>
