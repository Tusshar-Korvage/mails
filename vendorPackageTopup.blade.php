...
{{-- Subject: Your Top-Up for Packages Has Been Successful
Notification: Your recent top-up for Packages was successful. {X} credits have been added to your account. --}}
<body>
    ...
    <div class="container">
        ...
        <div>
            <p>We are excited to inform you that your recent top-up for Packages was successful. A total of {{ isset($credits) ? $credits : 'X' }} credits have been added to your account.</p>
        </div>
