...
Notification: {Vendor Name} has topped up for "Tagged Activity". Please review and update accordingly. --}}
<body>
    ...
    <div class="container">
        ...
        <div>
            <p>We want to inform you that {{ isset($vendor_name) ? $vendor_name : 'Vendor' }} has successfully topped up their current subscription plan for the "Tagged Activity".</p>
        </div>
